...
# Load raw data
raw = pd.read_csv("data/AT_hourly_MW_and_Price.csv", parse_dates=["Time (UTC)"])
raw = raw.set_index("Time (UTC)").sort_index()
raw = raw.loc["2017-01-01":"2022-12-31 23:00"]

# Capacity
cap = pd.read_csv("data/Installed Capacity per Production Type_201701010000-202301010000.csv")
